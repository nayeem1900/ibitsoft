            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Department <small>Edit Department</small></h2>
                            ...
                            <div class="x_content">
                              ...
                              <form action="{{route('department.update',$dept->id)}}" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="item form-group">
                                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Name of Department <span class="required">*</span>
                                      </label>
